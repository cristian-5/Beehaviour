...
execute store result score @s dispslotpick run loot spawn ~ ~ ~ loot beehave:rng/score

tellraw @a[tag=debug_logging] [{"text": "[Debug - beehave:dispenser/use_bone_meal] Using slot "},{"score":{"name": "@s","objective": "dispslotpick"}}]

execute if score @s dispenser_slot0 = @s dispslotpick run item modify block ~ ~ ~ container.0 beehave:general/remove_one_item
execute if score @s dispenser_slot0 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot1 = @s dispslotpick run item modify block ~ ~ ~ container.1 beehave:general/remove_one_item
execute if score @s dispenser_slot1 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot2 = @s dispslotpick run item modify block ~ ~ ~ container.2 beehave:general/remove_one_item
execute if score @s dispenser_slot2 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot3 = @s dispslotpick run item modify block ~ ~ ~ container.3 beehave:general/remove_one_item
execute if score @s dispenser_slot3 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot4 = @s dispslotpick run item modify block ~ ~ ~ container.4 beehave:general/remove_one_item
execute if score @s dispenser_slot4 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot5 = @s dispslotpick run item modify block ~ ~ ~ container.5 beehave:general/remove_one_item
execute if score @s dispenser_slot5 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot6 = @s dispslotpick run item modify block ~ ~ ~ container.6 beehave:general/remove_one_item
execute if score @s dispenser_slot6 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot7 = @s dispslotpick run item modify block ~ ~ ~ container.7 beehave:general/remove_one_item
execute if score @s dispenser_slot7 matches 1 run scoreboard players remove @s dispslotpick 1
execute if score @s dispenser_slot8 = @s dispslotpick run item modify block ~ ~ ~ container.8 beehave:general/remove_one_item
